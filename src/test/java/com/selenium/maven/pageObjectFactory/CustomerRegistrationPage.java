...
public class CustomerRegistrationPage 
{
	...
	public void customerRegistration() throws Exception
	{
		...
		//custEmail.sendKeys("qatest"+ randNumber() +"@gmail.com"); 
		selectEmail();
		//testRan();
		//randNumber();
	...
	public void selectEmail() throws Exception {
		...
		fis=new FileInputStream("C:\\Selenium_Practice_17\\AprilSeleniumMaven2pm\\or.properties");	
	    orProp=new Properties();
	    orProp.load(fis);
		custEmail.sendKeys(orProp.getProperty("user_name")+randNumber()+orProp.getProperty("email_address"));
